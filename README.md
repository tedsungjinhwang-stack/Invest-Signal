...
`.github/workflows/scan.yml`이 **4h봉 마감 10분 뒤**(KST
05:10/09:10/13:10/17:10/21:10, 하루 5회)에 자동 실행된다 — 심야 01시
마감 봉은 05:10 스캔이 소급 커버. 그 사이사이 봉 중간(KST
07:10/11:10/15:10/19:10/23:10 — 심야 03:10은 제외)에는
`scan-intrabar.yml`이 진행봉 포함 인트라바 스캔(펌핑·상승초입·눌림목)을
돌아 사실상 **2시간 간격**이 된다. (GitHub 크론 특성상 수십 분 지연될 수 있음)
