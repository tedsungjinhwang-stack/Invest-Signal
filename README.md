...
**인트라바 스캔**: 봉 마감 시각을 뺀 매시(`scan-intrabar.yml`, 봉당 3회)에
진행 중 봉을 포함해 스캔한다 — 펌핑 터치(봉 진행 중에도 확정되는
...
두 워크플로가 맞물려 **1시간 간격**으로 돈다 — 매시 01분에 하나씩,
하루 24회.

| 시각(KST) | 워크플로 | 판정 |
|---|---|---|
| 01·05·09·13·17·21시 | `scan.yml` | 4h봉 **마감** 1분 뒤 — 전 시그널 |
| 나머지 18개 시간 | `scan-intrabar.yml` | **진행봉** 포함 — 펌핑·펌핑초기·상승초입·눌림목 |
